...
- **File:** `claude_agent/core/config.py:30`, `claude_agent/core/cli.py:138-139`
...
- **File:** `claude_agent/core/process.py:21`, `claude_agent/core/process.py:50`
...
- **File:** `claude_agent/agents/code.py:6`
...
- **File:** `claude_agent/agents/research.py:6`
...
- **File:** `claude_agent/mcp/manager.py:49-56`
...
- **File:** `claude_agent/session/session.py:74-75`, `claude_agent/core/cli.py:124-125`
...
- **File:** `claude_agent/core/cli.py:141`, `claude_agent/agents/base.py:47-50`
...
- **File:** `claude_agent/session/history.py:53-72`
...
- **File:** `claude_agent/utils/helpers.py:9-11`
...
- **File:** `claude_agent/types/messages.py:19`
...
- **File:** `claude_agent/core/config.py:28`, `claude_agent/core/process.py:15`
...
- **File:** `claude_agent/core/command.py:97-101`
...
- **File:** `claude_agent/mcp/manager.py:49-56`, `claude_agent/mcp/server.py:16-19`
...
- **File:** `claude_agent/utils/errors.py:26-31`, `claude_agent/streaming/handler.py:29`
...
- **File:** `claude_agent/core/cli.py:35-50`
...
- **File:** `claude_agent/core/config.py:27`, `claude_agent/core/command.py:12`
...
| # | Severity | Title | File |
|---|----------|-------|------|
| 1 | High | Unsanitized `extra_flags` allows arbitrary CLI argument injection | `claude_agent/core/config.py:30`, `core/cli.py:138` |
| 2 | High | Prompt content logged at DEBUG level (sensitive data exposure) | `claude_agent/core/process.py:21,50` |
| 3 | High | `PermissionMode.BYPASS` exposed without guardrails | `claude_agent/types/enums.py:14` |
| 4 | Medium | `CodeAgent` grants unrestricted `Bash` tool by default | `claude_agent/agents/code.py:6` |
| 5 | Medium | `ResearchAgent` grants unrestricted `WebSearch`/`WebFetch` (SSRF risk) | `claude_agent/agents/research.py:6` |
| 6 | Medium | Insecure temporary file for MCP config (world-readable, no guaranteed cleanup) | `claude_agent/mcp/manager.py:49-56` |
| 7 | Medium | Unvalidated `session_id` from LLM response used in CLI arguments | `claude_agent/session/session.py:74-75` |
| 8 | Medium | Prompt injection risk — no sanitization of user input | `claude_agent/core/cli.py:141`, `agents/base.py:47` |
| 9 | Medium | `MessageHistory.load()` deserializes arbitrary JSON without schema validation | `claude_agent/session/history.py:53-72` |
| 10 | Medium | `expand_path` resolves env vars — potential path manipulation | `claude_agent/utils/helpers.py:9-11` |
| 11 | Low | `datetime.utcnow()` deprecated — use timezone-aware datetimes | `claude_agent/types/messages.py:19` |
| 12 | Low | No default timeout on process execution | `claude_agent/core/config.py:28`, `process.py:15` |
| 13 | Low | `add_flag()` accepts arbitrary strings without validation | `claude_agent/core/command.py:97-101` |
| 14 | Low | MCP server `env` dict may contain secrets written to disk | `claude_agent/mcp/manager.py:49-56`, `mcp/server.py:16` |
| 15 | Low | `ParseError.raw` may contain sensitive LLM output in exceptions | `claude_agent/utils/errors.py:26-31`, `streaming/handler.py:29` |
| 16 | Informational | No secret management — delegates entirely to CLI binary | Repository root |
| 17 | Informational | No input length limits on prompts | `claude_agent/core/cli.py:35-50` |
| 18 | Informational | External binary not integrity-verified at startup | `claude_agent/core/config.py:27` |
